...
namespace DecoratorPatternExample.OpenWeatherMap
{
    public class WeatherService : IWeatherService
    {
        ...
        public CurrentWeather GetCurrentWeather(string location)
        {
            ...
            {
                var currentConditions = JsonSerializer.Deserialize<CurrentConditionsResponse>(response.Content);
        ...
        public LocationForecast GetForecast(string location)
        {
            ...
            if (response.IsSuccessful)
            {
                var currentConditions = JsonSerializer.Deserialize<ForecastResponse>(response.Content);
